...
const prev = () => {
  ...
  return (
    <div>
        ...
        <button id="prev" onClick={prev} style={{height: "50px",textAlign: "center"}}  disabled={currentIndex === 0}>previous</button>
...
<button id="next" onClick={next} style={{height: "50px",textAlign: "center"}}  disabled={currentIndex === images.length - 1}>next</button>
</div>
    </div>
  )
}
